...
import PostBoardResponseto from './Post-Board.response.dto'
import PostCommentResponseDto from './Post-Board.response.dto'


export type{
    DeleteBoardResponseDto,GetBoardResponseDto,GetListResponseDto,
    GetMyListResponseDto,GetSearchListResponseDto,GetTop3ListResponseDto,
    GetTop15RelatedSearchWordResponseDto,GetTop15SearchWordResponseDto,
    LikeResponseDto,PatchBoardResponseDto,PostBoardResponseto,PostCommentResponseDto
}